...
app.include_router(admin_staff_router, prefix="/api/v1", tags=["admin-staff"])
...
app.include_router(checkout_sessions_router, prefix="/api/v1", tags=["checkout-sessions"])
